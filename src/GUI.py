...
def GUI(self, Gtk, GdkPixbuf):
    ...
    self.bntchannels = Gtk.Button(label="")
    bntchannels_label = self.bntchannels.get_child()
    bntchannels_label.set_markup("<span size='large'><b>Update Nix channels</b></span>")
    self.bntchannels.connect("clicked", self.on_channel_clicked)
    self.bntchannels.set_size_request(420, 70)
    ...
    if username == user:
        grid = Gtk.Grid()
        grid.attach(self.bntchannels, 4, 2, 2, 2)
        ...
        self.bntchannels.set_size_request(300, 70)
        ...
        grid.pack_start(self.bntchannels, True, False, 0)
